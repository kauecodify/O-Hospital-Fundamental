...
-- Inserir médicos
INSERT INTO Medicos (Nome, CPF, Endereco, EspecialidadeID) VALUES
('Dr. João', 12345678900, 'Rua A, 123', 1),
('Dr. Maria', 23456789012, 'Rua B, 456', 2),
('Dr. José', 34567890123, 'Rua C, 789', 3),
('Dr. Ana', 45678901234, 'Rua D, 1011', 4),
('Dr. Carlos', 56789012345, 'Rua E, 1213', 5),
('Dr. Laura', 67890123456, 'Rua F, 1415', 6),
('Dr. Pedro', 78901234567, 'Rua G, 1617', 7),
('Dr. Sofia', 89012345678, 'Rua H, 1819', 1),
('Dr. Luiz', 90123456789, 'Rua I, 2021', 2),
('Dr. Fernanda', 12345098765, 'Rua J, 2223', 3);
...
CREATE TABLE InternacoesEnfermeiros (
  ...
  FOREIGN KEY (InternacaoID) REFERENCES Internacoes(ID),
  FOREIGN KEY (EnfermeiroID) REFERENCES Enfermeiros(ID)
);
